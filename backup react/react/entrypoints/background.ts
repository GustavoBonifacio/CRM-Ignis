...
async function addLeadInRepo(input: { username: string; board: Board; avatarUrl?: string | null }) {
  ...
  if (typeof repo.addLead === "function") {
    return repo.addLead({
      ...
      board: input.board,
      // ✅ usa o mesmo stageId do Kanban (label), para não “sumir lead” no Dashboard
      stageId: "Leads novos",
